...
def get_metadata(url):
    try:
        ...
        v, l, c = info.get('view_count', 0), info.get('like_count', 0) or 0, info.get('comment_count', 0) or 0
    ...
    if not url_a or not url_b:
        ...
        with st.spinner("Processing..."):
            ...
            if 'A' in st.session_state.videos and 'B' in st.session_state.videos:
                st.success("✅ Videos processed! Chat coming soon...")
...
st.divider()
st.markdown("RAG Video Analyzer - Built with Streamlit + OpenAI")        r'(?:https?://)?(?:www\.)?youtube\.com/watch\?v=([a-zA-Z0-9_-]+)',
